...
OLD_TEMPLATE_PATTERN = re.compile(
    r"Software Architecture Foundation|software-architecture-foundation|\bSOLID\b|UAMS|Smart City|Architecture Styles"
)
PUBLIC_LEAK_PATTERN = re.compile(
...
def check_source_hygiene(errors: list[str]) -> None:
    for path in iter_text_files():
        ...
        if OLD_TEMPLATE_PATTERN.search(text):
