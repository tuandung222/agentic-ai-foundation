  ...
  lectureSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        '04-agent-to-agent/05-protocol-landscape',
        '04-agent-to-agent/06-mcp-deep-dive',
        '04-agent-to-agent/07-a2a-and-acp-merge',
        '04-agent-to-agent/08-anp-and-agora',
        '04-agent-to-agent/09-agntcy-and-slim',
        '04-agent-to-agent/10-agentic-commerce',
        '04-agent-to-agent/11-protocol-decision-framework',
      ],
    },
    {
      type: 'category',
